...
| TC-025 | Sorting | Rapid clicks | Click repeatedly | No crash or duplication | ✅ Pass |
...
| TC-042 | Edge Case | Many repos | Load many | Performance OK | ⚠️ Medium |
| TC-043 | Edge Case | API rate limit | Many requests | Risk exists | ⚠️ Risk |
